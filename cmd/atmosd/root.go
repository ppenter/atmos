...
func (a appCreator) appExport(
	...
	if height != -1 {
		atmosApp = app.NewAtmos(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := atmosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		atmosApp = app.NewAtmos(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return atmosApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
